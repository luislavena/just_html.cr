...
describe JustHTML::Encoding do
  ...
  describe ".prescan_meta_charset" do
    it "detects charset from meta tag" do
      ...
      result = JustHTML::Encoding.prescan_meta_charset(html.to_slice)
  ...
  describe ".normalize_encoding_name" do
    it "normalizes common encoding names" do
      JustHTML::Encoding.normalize_encoding_name("utf-8").should eq("UTF-8")
      JustHTML::Encoding.normalize_encoding_name("UTF8").should eq("UTF-8")
      JustHTML::Encoding.normalize_encoding_name("iso-8859-1").should eq("ISO-8859-1")
      JustHTML::Encoding.normalize_encoding_name("latin1").should eq("ISO-8859-1")
      JustHTML::Encoding.normalize_encoding_name("ascii").should eq("windows-1252")
    end

    it "returns nil for unknown encodings" do
      JustHTML::Encoding.normalize_encoding_name("unknown-encoding").should be_nil
    end
  end
